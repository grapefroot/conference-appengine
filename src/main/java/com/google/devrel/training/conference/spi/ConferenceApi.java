...
public class ConferenceApi {
    ...
    public Profile saveProfile(final User user, ProfileForm form) throws UnauthorizedException {
        ...
        Profile ex = getProfile(user);
        if(ex != null) {
            ex.update(form.getDisplayName(), form.getTeeShirtSize());
            return ex;
        }
    ...
    public Conference createConference(final User user, final ConferenceForm conferenceForm)
        ...
        final long conferenceId = conferenceKey.getId();
                ...
                if (profile == null) {
                    profile = new Profile(userId, extractDefaultDisplayNameFromEmail(user.getEmail()), user.getEmail(),
